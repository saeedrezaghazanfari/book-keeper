...
export default {
    ...
    data: () => ({
        ...
        voiceList: {
            ...
            bank_name_real_fa: '/audio/fa/bank_name_real.mp3',
            bank_name_again_en: '/audio/en/bank_name_again.mp3',
            bank_name_again_fa: '/audio/fa/bank_name_again.mp3',

            price_real_en: '/audio/en/price_real.mp3',
            price_real_fa: '/audio/fa/price_real.mp3',
            price_again_en: '/audio/en/price_again.mp3',
            price_again_fa: '/audio/fa/price_again.mp3',

            type_transaction_real_en: '/audio/en/type_transaction_real.mp3',
            type_transaction_real_fa: '/audio/fa/type_transaction_real.mp3',
            type_transaction_again_en: '/audio/en/type_transaction_again.mp3',
            type_transaction_again_fa: '/audio/fa/type_transaction_again.mp3',

            date_time_real_en: '/audio/en/date_time_real.mp3',
            date_time_real_fa: '/audio/fa/date_time_real.mp3',

            description_real_en: '/audio/en/description_real.mp3',
            description_real_fa: '/audio/fa/description_real.mp3',
